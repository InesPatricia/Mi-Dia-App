...
- **`docs/DESIGN_SYSTEM.md`** — the binding reference: full palette, the locked rose family, type, flower,
  hero, and what each colour is allowed to mean. (Was the "Visual design system (LOCKED)"
